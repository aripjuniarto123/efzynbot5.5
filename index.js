...
LolKey = '06dcc3b18c5f1ea163c6f6e6' //beli di https://api.lolhuman.xyz
...
reply(`${emror}`)
				...
				imglu = 'https://i.ibb.co/ZMCfv02/IMG-20210604-001051.jpg' //ubah sesuka kamu, bisa upload di imgbb.com
				veri = sender
				user.push(sender)
				fs.writeFileSync('./database/user.json', JSON.stringify(user))
...
//MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
                if (isBanned) return reply(dpa.baned)
                ngonrona = await fetchJson('https://dapuhy-api.herokuapp.com/api/corona?negara=indonesia')
...
//ISLAM MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				anu = await fetchJson(`https://dapuhy-api.herokuapp.com/api/doaharian`)
				teks = '=================\n'
...
//ANIME MENU
				...
				if (isLimit(sender)) return reply(dpa.limitend)
                reply(dpa.wait)
                woeee = await fetchJson(`https://dapuhy-api.herokuapp.com/api/storyanime`)
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=fuutarou%20uesugi`)
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=itsuki%20nakano`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=miku%20nakano`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=nino%20nakano`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=yotsuba%20nakano`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=ichika%20nakano`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=tanjiro%20kamado`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=nezuko%20kamado`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=zenitsu%20agatsuma`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=giyu%20tomioka`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=sakonji%20urokodaki`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=inosuke%20hashibira`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=shinobu%20kocho`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=kanao%20tsuyuri`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=sayu%20ogiwara`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=yoshida`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=airi%20gotou`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=asami%20yuuki`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=hashimoto`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=yuzuha%20mishima`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=eren%20yeager`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=mikasa%20ackerman`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=armin%20arlert`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=levi%20ackerman`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=bertholdt%20hoover`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=erwin%20smith`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=reiner%20braun`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=annie%20leonhart`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=hanji%20zoe`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=jean%20kirstein`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=connie%20springer`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=historia%20reiss`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=sasha%20braus`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=grisha%20jaeger`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=dot%20pixis`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=frieda%20reiss`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=carla%20jaeger`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=marco%20bodt`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=ymir%20attack%20on%20titan`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=floch%20forster`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=anka%20rheinberger`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=eld%20gin`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=rico%20brzenska`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=petra%20ral`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=ai%20ooto`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=momoe%20sawaki`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=neiru%20aonuma`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/googleimage?query=rika%20kawai`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
...
//ASUPAN MENU
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/${command}`)
...
//DOWNLOAD MENU
                ...
                reply(dpa.wait)
                link = args.join(' ')
                dppa = await fetchJson(`https://dapuhy-api.herokuapp.com/api/tiktokdownload?url=${link}`)
                ...
                reply(dpa.wait)
                urlnye = args[0]
                davva = await fetchJson(`https://dapuhy-api.herokuapp.com/api/ytmp3?url=${urlnye}`)
                gmteng = davva.result
                ...
                reply(dpa.wait)
                urlnye = args[0]
                davva = await fetchJson(`https://dapuhy-api.herokuapp.com/api/ytmp4?url=${urlnye}`)
                gmteng = davva.result
                hehe = `Judul : ${gmteng.title}\nChannel : ${gmteng.channel}\nPublished : ${gmteng.published}\nViews : ${gmteng.views}`
                tamnel = await getBuffer(gmteng.thumb)
                dp.sendMessage(from, tamnel, image, {quoted: freply, caption: hehe})
...
//FILM MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				anu = await fetchJson(`https://dapuhy-api.herokuapp.com/api/jadwalbioskop`)
				teks = '=================\n'
				for (let i of anu.result) {
				teks += `Title : ${i.title}\nImage : ${i.img}\nUrl : ${i.url}\n=================\n`
				}
